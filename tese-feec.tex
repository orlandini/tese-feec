...
%defina o nome da área de concetração nas três línguas
\areapt{Telecomunicações e Telemática}
\areaen{Telecommunications and Telematics}
\areaes{Telecomunicaciones y Telemática}
